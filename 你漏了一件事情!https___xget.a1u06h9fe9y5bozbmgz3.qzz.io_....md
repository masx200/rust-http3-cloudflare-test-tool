...
let dns_url \= format\!(\
"https://fresh-reverse-proxy-middle.masx201.dpdns.org/token/4yF6nSCifSLs8lfkb4t8OWP69kfpgiun/https/dns.adguard-dns.com/dns-query?name={}\&type={}",\
domain, type_param\
);
...
1. **防污染解析 (resolve_via_doh)**:
   - 这个函数现在显式调用了你提供的
     URL：https://fresh-reverse-proxy-middle.masx201.dpdns.org/token/4yF6nSCifSLs8lfkb4t8OWP69kfpgiun/https/dns.adguard-dns.com/dns-query。
