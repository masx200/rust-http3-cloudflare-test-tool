...
a `hickory-dns` binary that can be generated from the library with
`cargo
...
[hickory-dns](https://crates.io/crates/hickory-dns), from `0.24` and onward, for
prior versions see [trust-dns](https://crates.io/crates/trust-dns).
